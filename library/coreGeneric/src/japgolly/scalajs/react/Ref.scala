...
object Ref {
  ...
  def toJsComponentWithMountedFacade[P <: js.Object, S <: js.Object, F <: js.Object]: ToJsComponent[P, S, JsComponent.RawMounted[P, S] & F] =
    apply[JsComponent.RawMounted[P, S] & F].map(JsComponent.mounted[P, S](_).addFacade[F])
  ...
  final class WithJsComponentArg[F[_], A[_], P1, S1, CT1[-p, +u] <: CtorType[p, u], R <: JsComponent.RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object]
      (val wrap: ToJsComponent[P0, S0, JsComponent.RawMounted[P0, S0] & R] =>
                 WithJsComponent[F, A, P1, S1, CT1, R, P0, S0]
      ) extends AnyVal
