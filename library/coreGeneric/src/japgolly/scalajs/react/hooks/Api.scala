...
object Api {
  ...
  trait Primary[Ctx, _Step <: AbstractStep] {
    ...
    /** Create a mutable ref that will persist for the full lifetime of the component. */
    final def useRefToJsComponentWithMountedFacade[P <: js.Object, S <: js.Object, F <: js.Object](implicit step: Step): step.Next[Ref.ToJsComponent[P, S, JsComponent.RawMounted[P, S] & F]] =
