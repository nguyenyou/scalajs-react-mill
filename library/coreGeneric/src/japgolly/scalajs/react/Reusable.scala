...
object Reusable {
  ...
  private val reusabilityInstance =
  ...
  private object FnInternals {
    ...
    private val _reusabilityFn1: Reusability[Fn1[?, ?]] =
    ...
    private val _reusabilityFn2: Reusability[Fn2[?, ?, ?]] =
      Reusability((x, y) => (x eq y) || (x.f eq y.f))
    ...
    private val _reusabilityFn3: Reusability[Fn3[?, ?, ?, ?]] =
      Reusability((x, y) => (x eq y) || (x.f eq y.f))
