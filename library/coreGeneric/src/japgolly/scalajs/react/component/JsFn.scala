...
object JsFn extends JsBaseComponentTemplate[facade.React.StatelessFunctionalComponent] {
  ...
  def fromJsFn[P <: js.Object, C <: Children](render: js.Function1[P & facade.PropsWithChildren, facade.React.Element])
  ...
  object fromScala {
    ...
    def generic[P <: js.Object, C <: Children](render: P & facade.PropsWithChildren => VdomElement)
                                              (implicit s: CtorType.Summoner[P, C]): Component[P, s.CT] =
      fromJsFn[P, C]((p: P & facade.PropsWithChildren) => render(p).rawElement)(s)
