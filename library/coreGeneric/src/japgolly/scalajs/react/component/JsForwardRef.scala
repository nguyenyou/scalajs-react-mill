...
object JsForwardRef {
  ...
  private def rawComponentDisplayName: facade.React.ForwardRefComponent[? <: js.Object, ?] => String =
  ...
  sealed trait ComponentSimple[P, R, CT[-p, +u] <: CtorType[p, u], U] extends Generic.ComponentSimple[P, CT, U] {
    ...
    override type Raw <: facade.React.ForwardRefComponent[? <: js.Object, R]
  ...
  private def setRef[CT[-p, +u] <: CtorType[p, u], P, U](c: CT[P, U], ref: Ref.Handle[?]): CT[P, U] =
