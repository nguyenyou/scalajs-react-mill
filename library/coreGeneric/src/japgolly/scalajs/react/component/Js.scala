...
object Js extends JsBaseComponentTemplate[facade.React.ComponentClassP] {
  ...
  type ComponentWithFacade[P <: js.Object, S <: js.Object, F <: js.Object, CT[-p, +u] <: CtorType[p, u]] = ComponentWithRawType[P, S, RawMounted[P, S] & F, CT]
  type UnmountedWithFacade[P <: js.Object, S <: js.Object, F <: js.Object]                               = UnmountedWithRawType[P, S, RawMounted[P, S] & F]
  type   MountedWithFacade[P <: js.Object, S <: js.Object, F <: js.Object]                               =   MountedWithRawType[P, S, RawMounted[P, S] & F]
  ...
  sealed trait MountedSimple[F[_], A[_], P, S, R <: RawMounted[? <: js.Object, ? <: js.Object]] extends Generic.MountedSimple[F, A, P, S] {
  ...
  sealed trait MountedWithRoot[F[_], A[_], P1, S1, R <: RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object]
    ...
    override final def addFacade[T <: js.Object]: MountedWithRoot[F, A, P1, S1, R & T, P0, S0] =
      withRawType[R & T]
  }
  ...
  final class JsUnmountedOps[
    ...
    def addFacade[T <: js.Object]: UnmountedMapped[F, A, P1, S1, R & T, P0, S0] =
      withRawType[R & T]
  ...
  final class JsComponentOps[
    ...
    def addFacade[T <: js.Object]: ComponentMapped[F, A, P1, S1, CT1, R & T, P0, S0, CT0] =
      withRawType[R & T]
