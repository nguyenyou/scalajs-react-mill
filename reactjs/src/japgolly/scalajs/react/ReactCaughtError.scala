...
/** The data captured by React when it catches an error for the
  ...
  *
  * @param rawError
  *   The JS error. Usually a [[js.Error]]. If you threw an error using `throw
  *   js.JavaScriptException("OMG")` then is value is just the argument `"OMG"`.
  * @since 1.6.0
  */
final case class ReactCaughtError(
    rawError: js.Any,
    rawInfo: facade.React.ErrorInfo
) {
