...
/** This is mutable so don't let it escape a local pure function. Elements must
  * have keys. VdomArray itself cannot be assigned a key.
  */
final class VdomArray(val rawArray: js.Array[facade.React.Node])
    extends VdomNode {
