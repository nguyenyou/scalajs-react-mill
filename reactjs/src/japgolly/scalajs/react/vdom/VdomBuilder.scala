...
trait VdomBuilder {
  ...
  def addAttrsObject(
      o: js.Object,
      allowAttr: String => Boolean = _ => true
  ): Unit =
...
object VdomBuilder {
  ...
  @inline def modObjectKeyValue[A <: js.Any](
      o: js.Object,
      k: String,
      v: js.UndefOr[A] => A
  ): Unit = {
    val cur =
      o.asInstanceOf[js.Dynamic].selectDynamic(k).asInstanceOf[js.UndefOr[A]]
  ...
  /** Raw JS values of:
    ...
    *
    * There are convenience methods to (mutably) add className and styles to
    * props.
    */
  trait ToJs extends VdomBuilder {
    ...
    def nonEmptyChildren: js.UndefOr[js.Array[RawChild]] = nonEmptyJsArray(
      children
    )
    ...
    override val addClassName: js.Any => Unit =
      n =>
        nonEmptyClassName =
          nonEmptyClassName.fold[js.Any](n)(_.toString + " " + n)

    override val addEventHandler =
      (k, g) =>
        modObjectKeyValue[js.Function1[js.Any, Any]](
          props,
          k,
  ...
  object ToRawReactElement {
    ...
    val build: BuildFn = {
      ...
      (tag, props, key, children) =>
        {
          key.foreach(setObjectKeyValue(props, "key", _))
          facade.React.createElement(tag, props, children.toSeq*)
        }
