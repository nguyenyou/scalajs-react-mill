...
object ReactOptions {
  ...
  final case class CreateRoot(
      identifierPrefix: js.UndefOr[String] = js.undefined,
    ...
    def raw(): facade.CreateRootOptions = {
      ...
      o.unstable_concurrentUpdatesByDefault =
        self.unstable_concurrentUpdatesByDefault
