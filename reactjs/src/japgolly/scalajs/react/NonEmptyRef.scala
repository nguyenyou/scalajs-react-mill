...
object NonEmptyRef {
  ...
  trait GetF[F[_], A] { self =>
    ...
    /** Get the reference immediately.
      ...
      *
      * Unsafe in the FP sense because it reads an underlying variable which is
      * impure.
      */
  ...
  def FullF[F[_], I, A, O](
      _raw: facade.React.RefHandle[A],
      l: I => A,
      r: A => O
  )(implicit FF: Sync[F]): FullF[F, I, A, O] =
    new FullF[F, I, A, O] {
