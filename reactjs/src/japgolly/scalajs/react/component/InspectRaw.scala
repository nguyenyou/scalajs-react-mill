...
object InspectRaw {
  ...
  @inline def assertValidJsComponent(
      input: => Any,
    ...
    if (developmentMode) {
      ...
      devAssert(
        i match {
          ...
          case o: js.Object =>
            List("$$typeof", "type").exists(js.Object.hasProperty(o, _))
          case _ => false
        },
  ...
  @inline def assertValidJsForwardRefComponent(
      input: => Any,
      where: => sourcecode.File,
      line: => sourcecode.Line
  ): Unit =
  ...
  private def typeSymbolIs(input: Any, expect: String): Boolean =
    input match {
      case o: js.Object =>
        val t =
          o.asInstanceOf[js.Dynamic].selectDynamic("$$typeof").asInstanceOf[Any]
