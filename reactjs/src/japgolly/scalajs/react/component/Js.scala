...
object Js extends JsBaseComponentTemplate[facade.React.ComponentClassP] {
  ...
  def apply[P <: js.Object, C <: Children, S <: js.Object](raw: Any)(implicit
      s: CtorType.Summoner[P, C],
      where: sourcecode.File,
  ...
  def force[P <: js.Object, C <: Children, S <: js.Object](
      raw: Any
  ...
  type Component[P <: js.Object, S <: js.Object, CT[-p, +u] <: CtorType[p, u]] =
    ComponentWithRawType[P, S, RawMounted[P, S], CT]
  type Unmounted[P <: js.Object, S <: js.Object] =
    UnmountedWithRawType[P, S, RawMounted[P, S]]
  type Mounted[P <: js.Object, S <: js.Object] =
    MountedWithRawType[P, S, RawMounted[P, S]]

  type ComponentWithFacade[P <: js.Object, S <: js.Object, F <: js.Object, CT[
      -p,
      +u
  ] <: CtorType[p, u]] = ComponentWithRawType[P, S, RawMounted[P, S] & F, CT]
  type UnmountedWithFacade[P <: js.Object, S <: js.Object, F <: js.Object] =
    UnmountedWithRawType[P, S, RawMounted[P, S] & F]
  type MountedWithFacade[P <: js.Object, S <: js.Object, F <: js.Object] =
    MountedWithRawType[P, S, RawMounted[P, S] & F]

  type ComponentWithRawType[P <: js.Object, S <: js.Object, R <: RawMounted[
    P,
    S
  ], CT[-p, +u] <: CtorType[p, u]] =
    ComponentRoot[P, CT, UnmountedWithRawType[P, S, R]]
  type UnmountedWithRawType[P <: js.Object, S <: js.Object, R <: RawMounted[
    P,
    S
  ]] = UnmountedRoot[P, MountedWithRawType[P, S, R]]
  type MountedWithRawType[P <: js.Object, S <: js.Object, R <: RawMounted[
    P,
    S
  ]] = MountedRoot[Id, DefaultA, P, S, R]

  private def readDisplayName(a: facade.HasDisplayName): String =
    a.displayName.getOrElse("")

  override protected def rawComponentDisplayName[A <: js.Object](
      r: facade.React.ComponentClassP[A]
  ) =
    readDisplayName(r)
  ...
  sealed trait UnmountedSimple[P, M] extends Generic.UnmountedSimple[P, M] {
    ...
    override type Raw <: facade.React.ComponentElement[? <: js.Object]
  ...
  sealed trait UnmountedWithRoot[P1, M1, P0 <: js.Object, M0]
      extends UnmountedSimple[P1, M1]
      with Generic.UnmountedWithRoot[P1, M1, P0, M0] {
  ...
  def unmountedRoot[P <: js.Object, S <: js.Object, M](
      r: facade.React.ComponentElement[P],
      m: facade.React.Component[P, S] => M
  ): UnmountedRoot[P, M] =
    new UnmountedRoot[P, M] {
      override def root = this
      override val raw = r
      override val mountRaw =
        m.asInstanceOf[facade.React.ComponentUntyped => M] // TODO Do better
  ...
  )(mp: P1 => P2, mm: M1 => M2): UnmountedWithRoot[P2, M2, P0, M0] =
  ...
  sealed trait MountedSimple[F[_], A[_], P, S, R <: RawMounted[
    ? <: js.Object,
    ? <: js.Object
    ...
    def addFacade[T <: js.Object]: MountedSimple[F, A, P, S, R & T]
    // def getDefaultProps: Props
    // def getInitialState: js.Object | Null
    // def render(): React.Element
  }

  sealed trait MountedWithRoot[F[_], A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object]
      extends MountedSimple[F, A, P1, S1, R]
    ...
    override final type WithEffect[F2[_]] =
      MountedWithRoot[F2, A, P1, S1, R, P0, S0]
    override final type WithAsyncEffect[A2[_]] =
      MountedWithRoot[F, A2, P1, S1, R, P0, S0]
    override final type WithMappedProps[P2] =
      MountedWithRoot[F, A, P2, S1, R, P0, S0]
    override final type WithMappedState[S2] =
      MountedWithRoot[F, A, P1, S2, R, P0, S0]

    final def withRawType[R2 <: RawMounted[P0, S0]]
        : MountedWithRoot[F, A, P1, S1, R2, P0, S0] =
      this.asInstanceOf[MountedWithRoot[F, A, P1, S1, R2, P0, S0]]

    override final def addFacade[T <: js.Object]
        : MountedWithRoot[F, A, P1, S1, R & T, P0, S0] =
      withRawType[R & T]
  }

  type MountedRoot[F[_], A[_], P <: js.Object, S <: js.Object, R <: RawMounted[
    P,
    S
  ]] = MountedWithRoot[F, A, P, S, R, P, S]

  def mountedRoot[P <: js.Object, S <: js.Object, R <: RawMounted[P, S]](
      r: R
  ): MountedRoot[Id, DefaultA, P, S, R] =
    new Template.MountedWithRoot[Id, DefaultA, P, S]()(UnsafeSync.id, DefaultA)
      ...
      override def setState[G[_]](state: S, callback: => G[Unit])(implicit
          G: Dispatch[G]
      ): Unit =
      ...
      override def setStateOption[G[_]](state: Option[S], callback: => G[Unit])(
          implicit G: Dispatch[G]
      ): Unit =
      ...
      override type Mapped[F1[_], A1[_], P1, S1] =
        MountedWithRoot[F1, A1, P1, S1, R, P, S]
      override def mapped[F[_], A[_], P1, S1](
          mp: P => P1,
          ls: Lens[S, S1]
  ...
  private def mappedM[F[_], A[_], P2, S2, P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object](
  ...
  def component[P <: js.Object, C <: Children, S <: js.Object](
      rc: facade.React.ComponentClass[P, S]
  )(implicit s: CtorType.Summoner[P, C]): Component[P, S, s.CT] =
    componentRoot[P, s.CT, Unmounted[P, S]](
      rc,
      s.pf.rmap(s.summon(rc))(unmounted)
    )(s.pf)

  def unmounted[P <: js.Object, S <: js.Object](
      r: facade.React.ComponentElement[P]
  ): Unmounted[P, S] =
    unmountedRoot(r, mounted[P, S])

  def mounted[P <: js.Object, S <: js.Object](
      r: RawMounted[P, S]
  ): Mounted[P, S] =
    mountedRoot(r)
  ...
  type ComponentMapped[F[_], A[_], P1, S1, CT1[-p, +u] <: CtorType[
    p,
    u
  ], R <: RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object, CT0[
      -p,
      +u
  ] <: CtorType[p, u]] =
    ComponentWithRoot[
      P1,
      CT1,
      UnmountedMapped[F, A, P1, S1, R, P0, S0],
      P0,
      CT0,
      UnmountedWithRawType[P0, S0, R]
    ]

  type UnmountedMapped[F[_], A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object] =
    UnmountedWithRoot[
      P1,
      MountedMapped[F, A, P1, S1, R, P0, S0],
      P0,
      MountedWithRawType[P0, S0, R]
    ]

  type MountedMapped[F[_], A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object] =
    MountedWithRoot[F, A, P1, S1, R, P0, S0]

  implicit def toJsUnmountedOps[F[_], A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object](
      x: UnmountedMapped[F, A, P1, S1, R, P0, S0]
  ): JsUnmountedOps[F, A, P1, S1, R, P0, S0] = new JsUnmountedOps(x)
  implicit def toJsComponentOps[F[_], A[_], P1, S1, CT1[-p, +u] <: CtorType[
    p,
    u
  ], R <: RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object, CT0[
      -p,
      ...
      x: ComponentMapped[F, A, P1, S1, CT1, R, P0, S0, CT0]
  ): JsComponentOps[F, A, P1, S1, CT1, R, P0, S0, CT0] = new JsComponentOps(x)

  // Scala bug requires special help for the Effect.Id case
  implicit def toJsUnmountedOpsI[A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object](
      x: UnmountedMapped[Id, A, P1, S1, R, P0, S0]
  ): JsUnmountedOps[Id, A, P1, S1, R, P0, S0] = new JsUnmountedOps(x)
  implicit def toJsComponentOpsI[A[_], P1, S1, CT1[-p, +u] <: CtorType[
    p,
    u
  ], R <: RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object, CT0[
      -p,
      ...
      x: ComponentMapped[Id, A, P1, S1, CT1, R, P0, S0, CT0]
  ): JsComponentOps[Id, A, P1, S1, CT1, R, P0, S0, CT0] = new JsComponentOps(x)

  final class JsUnmountedOps[F[_], A[_], P1, S1, R <: RawMounted[
    P0,
    S0
  ], P0 <: js.Object, S0 <: js.Object](
      private val self: UnmountedMapped[F, A, P1, S1, R, P0, S0]
  ) extends AnyVal {

    def withRawType[R2 <: RawMounted[P0, S0]]
        : UnmountedMapped[F, A, P1, S1, R2, P0, S0] =
      self.asInstanceOf[UnmountedMapped[F, A, P1, S1, R2, P0, S0]]
    def addFacade[T <: js.Object]
        : UnmountedMapped[F, A, P1, S1, R & T, P0, S0] =
      withRawType[R & T]
    def mapProps[P2](f: P1 => P2): UnmountedMapped[F, A, P2, S1, R, P0, S0] =
      self.mapUnmountedProps(f).mapMounted(_ `mapProps` f)
    def xmapState[S2](f: S1 => S2)(
        g: S2 => S1
    ): UnmountedMapped[F, A, P1, S2, R, P0, S0] =
      self.mapMounted(_.xmapState(f)(g))
    def zoomState[S2](get: S1 => S2)(
        set: S2 => S1 => S1
    ): UnmountedMapped[F, A, P1, S2, R, P0, S0] =
      self.mapMounted(_.zoomState(get)(set))
  }

  final class JsComponentOps[F[_], A[_], P1, S1, CT1[-p, +u] <: CtorType[
    p,
    u
  ], R <: RawMounted[P0, S0], P0 <: js.Object, S0 <: js.Object, CT0[
      -p,
      ...
      private val self: ComponentMapped[F, A, P1, S1, CT1, R, P0, S0, CT0]
  ) extends AnyVal {

    def withRawType[R2 <: RawMounted[P0, S0]]
        : ComponentMapped[F, A, P1, S1, CT1, R2, P0, S0, CT0] =
      self.asInstanceOf[ComponentMapped[F, A, P1, S1, CT1, R2, P0, S0, CT0]]
    def addFacade[T <: js.Object]
        : ComponentMapped[F, A, P1, S1, CT1, R & T, P0, S0, CT0] =
      withRawType[R & T]
    def xmapProps[P2](f: P1 => P2)(
        g: P2 => P1
    ): ComponentMapped[F, A, P2, S1, CT1, R, P0, S0, CT0] =
      self.cmapCtorProps(g).mapUnmounted(_ `mapProps` f)
    def xmapState[S2](f: S1 => S2)(
        g: S2 => S1
    ): ComponentMapped[F, A, P1, S2, CT1, R, P0, S0, CT0] =
