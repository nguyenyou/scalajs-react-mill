...
trait JsBaseComponentTemplate[RawComponent[_ <: js.Object] <: js.Any] {
  ...
  protected def rawComponentDisplayName[A <: js.Object](
      r: RawComponent[A]
  ): String
  ...
  sealed trait ComponentSimple[P, CT[-p, +u] <: CtorType[p, u], U]
      extends Generic.ComponentSimple[P, CT, U] {
    ...
    override def mapCtorType[CT2[-p, +u] <: CtorType[p, u]](
        f: CT[P, U] => CT2[P, U]
    )(implicit pf: Profunctor[CT2]): ComponentSimple[P, CT2, U]
  }

  sealed trait ComponentWithRoot[P1, CT1[-p, +u] <: CtorType[
    p,
    u
  ], U1, P0 <: js.Object, CT0[-p, +u] <: CtorType[p, u], U0]
      extends ComponentSimple[P1, CT1, U1]
      with Generic.ComponentWithRoot[P1, CT1, U1, P0, CT0, U0] {
  ...
  final def componentRoot[P <: js.Object, CT[-p, +u] <: CtorType[p, u], U](
      rc: RawComponent[P],
      c: CT[P, U]
    ...
    new ComponentRoot[P, CT, U] {
      ...
      override def cmapCtorProps[P2](f: P2 => P) =
        mappedC(this)(f, identityFn, identityFn, pf)
      override def mapUnmounted[U2](f: U => U2) =
        mappedC(this)(identityFn, identityFn, f, pf)
      override def mapCtorType[CT2[-p, +u] <: CtorType[p, u]](
          f: CT[P, U] => CT2[P, U]
  ...
  protected final def mappedC[P2, CT2[-p, +u] <: CtorType[p, u], U2, P1, CT1[
      -p,
      +u
  ] <: CtorType[p, u], U1, P0 <: js.Object, CT0[-p, +u] <: CtorType[p, u], U0](
      from: ComponentWithRoot[P1, CT1, U1, P0, CT0, U0]
  )(
      cp: P2 => P1,
      mc: CT1[P1, U1] => CT2[P1, U1],
      mu: U1 => U2,
      pf: Profunctor[CT2]
    ...
    new ComponentWithRoot[P2, CT2, U2, P0, CT0, U0] {
      ...
      override implicit def ctorPF = pf
      override def mapRaw(f: Raw => Raw) =
        mappedC(from.mapRaw(f))(cp, mc, mu, pf)
      override def cmapCtorProps[P3](f: P3 => P2) =
        mappedC(from)(cp compose f, mc, mu, pf)
      override def mapUnmounted[U3](f: U2 => U3) =
        mappedC(from)(cp, mc, f compose mu, pf)
      override def mapCtorType[CT3[-p, +u] <: CtorType[p, u]](
          f: CT2[P2, U2] => CT3[P2, U2]
      )(implicit pf3: Profunctor[CT3]) =
