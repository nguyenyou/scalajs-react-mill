...
abstract class EffectFallbacks extends EffectFallbacks1 // Defaults
...
abstract class EffectFallbacks4 extends EffectFallbacks5
abstract class EffectFallbacks5 extends userdefined.Effects
