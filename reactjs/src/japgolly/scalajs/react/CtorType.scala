...
object CtorType {
  ...
  @inline def hackBackToSelf[CT[-p, +u] <: CtorType[p, u], P2, U2](
      c: CT[Nothing, Any]
  )(t: c.This[P2, U2]): CT[P2, U2] =
    t.asInstanceOf[CT[P2, U2]]

  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // Types

  final class PropsAndChildren[-P, +U](
      private[CtorType] val construct: (P, MaybeMod, ChildrenArgs) => U,
      private[CtorType] val mods: MaybeMod
  ) extends CtorType[P, U] {
  ...
  final class Props[-P, +U](
      private[CtorType] val construct: (P, MaybeMod) => U,
      private[CtorType] val mods: MaybeMod
  ) extends CtorType[P, U] {
  ...
  final class Children[-P, +U](
      private[CtorType] val construct: (MaybeMod, ChildrenArgs) => U,
      private[CtorType] val mods: MaybeMod
  ) extends CtorType[P, U] {
  ...
  final class Nullary[-P, +U](
      private[CtorType] val unmodified: U,
  ...
  implicit object ProfunctorN extends Profunctor[Nullary] {
    override def lmap[A, B, C](x: Nullary[A, B])(f: C => A) =
      x.asInstanceOf[Nullary[C, B]]
    override def rmap[A, B, C](x: Nullary[A, B])(g: B => C) =
      new Nullary(g(x.unmodified), g compose x.construct, x.mods)
    override def dimap[A, B, C, D](x: Nullary[A, B])(f: C => A, g: B => D) =
      new Nullary(g(x.unmodified), g compose x.construct, x.mods)
  }
  ...
  object Summoner {
    ...
    def apply[P <: js.Object, C <: ChildrenArg, T[-p, +u] <: CtorType[p, u]](
        f: facade.React.ComponentType[P] => T[
          P,
          facade.React.ComponentElement[P]
        ]
    ...
    implicit def summonN[P <: js.Object](implicit
        s: Singleton[P]
    ): Summoner.Aux[P, ChildrenArg.None, Nullary] =
      Summoner[P, ChildrenArg.None, Nullary](rc =>
        new Nullary[P, facade.React.ComponentElement[P]](
          facade.React.createElement(rc, s.value),
          m =>
            facade.React
              .createElement[P](rc, m.applyAndCast[P](s.mutableObj())),
          noMod
        )
      )

    implicit def summonC[P <: js.Object](implicit
        s: Singleton[P]
    ): Summoner.Aux[P, ChildrenArg.Varargs, Children] =
      Summoner[P, ChildrenArg.Varargs, Children](rc =>
        new Children[P, facade.React.ComponentElement[P]](
          (mm, c) => {
            val p = mm.fold(s.value)(_.applyAndCast[P](s.mutableObj()))
            facade.React.createElement[P](rc, p, formatChildren(c)*)
          },
          noMod
        )
      )
    ...
    @nowarn("cat=unused")
    implicit def summonPC[P <: js.Object](implicit
        w: Singleton.Not[P]
    ): Summoner.Aux[P, ChildrenArg.Varargs, PropsAndChildren] =
      Summoner[P, ChildrenArg.Varargs, PropsAndChildren](rc =>
        new PropsAndChildren[P, facade.React.ComponentElement[P]](
          (p, mm, c) => {
            val p2 = mm.fold(p)(_.applyAndCast[P](prepareForMutation(p)))
            facade.React.createElement[P](rc, p2, formatChildren(c)*)
          },
          noMod
        )
      )
    ...
    @nowarn("cat=unused")
    implicit def summonP[P <: js.Object](implicit
        w: Singleton.Not[P]
    ): Summoner.Aux[P, ChildrenArg.None, Props] =
      Summoner[P, ChildrenArg.None, Props](rc =>
        new Props[P, facade.React.ComponentElement[P]](
          (p, mm) => {
            val p2 = mm.fold(p)(_.applyAndCast[P](prepareForMutation(p)))
